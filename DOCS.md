...
To add the GitHub OIDC provider to IAM, see the [AWS docs](https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_providers_create_oidc.html).
...
| `region`                   | AWS region where the role exists                                                                                                                                               | `false`  | `us-east-1`                  | `PARAMETER_REGION`<br>`AWS_CREDENTIALS_REGION`                                     |
...
| `script_path`              | Path where to write script that contains AWS credentials                                                                                                                       | `false`  | `/vela/secrets/aws/setup.sh` | `PARAMETER_SCRIPT_PATH`<br>`AWS_CREDENTIALS_SCRIPT_PATH`                           |
