...
```bash
# Clone the project
git clone git@github.com:Cargill/vela-aws-credentials.git $HOME/Cargill/vela-aws-credentials
```
...
cd $HOME/Cargill/vela-aws-credentials
```
...
git remote add fork https://github.com/your_fork/vela-aws-credentials
```
